Webruntime.define('lwc/navigationBar', ['lwc'], function (lwc) { 'use strict';

  function stylesheet(hostSelector, shadowSelector, nativeShadow) {
    return ".header" + shadowSelector + "\r{background-color: grey;display: flex;align-items:center;}\n.logo" + shadowSelector + "\r{width: 40%;}\n.navigation" + shadowSelector + "\r{font-size:2vw;display: flex;align-items:left;}\n.navLinks" + shadowSelector + "\r{padding: 2%;list-style-type: none;}\n";
  }
