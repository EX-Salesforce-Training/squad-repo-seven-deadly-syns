Webruntime.define('lwc/navigationBar', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
  ...
  **/
  ...
  function tmpl$3($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("div", {
      ...
      key: 2,
      on: {
        "click": _m0 || ($ctx._m0 = api_bind($cmp.navigationToHome))
      }
    }, [])]), api_element("li", {
      classMap: {
        "navLinks": true
      ...
      key: 4,
      on: {
        "click": _m1 || ($ctx._m1 = api_bind($cmp.navigationToGames))
      }
    }, [])]), api_element("li", {
      classMap: {
        "navLinks": true
      ...
      key: 6,
      on: {
        "click": _m2 || ($ctx._m2 = api_bind($cmp.navigationToContact))
      }
    }, [])]), api_element("li", {
      classMap: {
        "navLinks": true
      ...
      key: 8,
      on: {
        "click": _m3 || ($ctx._m3 = api_bind($cmp.navigationToSupport))
      }
    }, [])]), api_element("li", {
      classMap: {
        "navLinks": true
      ...
      key: 10,
      on: {
        "click": _m4 || ($ctx._m4 = api_bind($cmp.navigationToAboutUs))
      }
    }, [])])])])])];
  }
  ...
  class navigationBar extends lwc.LightningElement {
    ...
    navigationToHome() {
      this.HomePage = true;
      const selectedEvent = new CustomEvent("toHome", {
        detail: this.HomePage
      });
    ...
    navigationToGames() {
      this.Games = true;
      const selectedEvent = new CustomEvent("toGames", {
        detail: this.Games
      });
      this.dispatchEvent(selectedEvent);
    }
    ...
    navigationToContact() {
      this.Contact = true;
      const selectedEvent = new CustomEvent("toContact", {
        detail: this.Contact
      });
      this.dispatchEvent(selectedEvent);
    }
    ...
    navigationToSupport() {
      this.Support = true;
      const selectedEvent = new CustomEvent("toSupport", {
        detail: this.Support
      });
      this.dispatchEvent(selectedEvent);
    }
    ...
    navigationToCareers() {
      this.Careers = true;
      const selectedEvent = new CustomEvent("toCareers", {
        detail: this.Careers
      });
      this.dispatchEvent(selectedEvent);
    }
    ...
    navigationToAboutUs() {
      this.AboutUs = true;
      const selectedEvent = new CustomEvent("toAboutUs", {
        detail: this.AboutUs
      });
      this.dispatchEvent(selectedEvent);
    }
  ...
  lwc.registerDecorators(navigationBar, {
    publicProps: {
      HomePage: {
        config: 0
      },
  ...
  var navigationBar$1 = lwc.registerComponent(navigationBar, {
    tmpl: _tmpl$4
  });
