Webruntime.define('lwc/navigationBar', ['lwc', 'lightning/navigation'], function (lwc, navigation) { 'use strict';
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    }, [api_text("Account Home")])]), api_element("li", {
      classMap: {
        "navLinks": true
      },
      key: 8
  ...
  class NavigationBar extends navigation.NavigationMixin(lwc.LightningElement) {
    constructor(...args) {
      super(...args);
      this.url = void 0;
    }
    ...
    connectedCallback() {
      ...
      this[navigation.NavigationMixin.GenerateUrl](this.accountHomePageRef).then(url => this.url = url);
    }
    ...
    handleClick(evt) {
      ...
      evt.preventDefault();
      evt.stopPropagation(); // Navigate to the Account Home page.

      this[navigation.NavigationMixin.Navigate](this.accountHomePageRef);
    }
