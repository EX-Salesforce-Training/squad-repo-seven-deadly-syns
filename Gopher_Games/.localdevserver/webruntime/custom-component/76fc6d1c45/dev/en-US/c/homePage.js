Webruntime.define('lwc/homePage', ['lwc', 'c/navigationBar', 'c/gameTitles', 'c/newsEvents', 'c/footer', 'c/homePage', 'c/underConstruction'], function (lwc, _cNavigationBar, _cGameTitles, _cNewsEvents, _cFooter, _cHomePage, _cUnderConstruction) { 'use strict';
  ...
  class HomePage$1 extends Base$1 {
    constructor(...args) {
      super(...args);
  ...
  lwc.registerDecorators(HomePage$1, {
    fields: ["image1", "image2", "image3", "image4", "image5"]
  });

  var homePage = lwc.registerComponent(HomePage$1, {
    tmpl: _tmpl
  });
