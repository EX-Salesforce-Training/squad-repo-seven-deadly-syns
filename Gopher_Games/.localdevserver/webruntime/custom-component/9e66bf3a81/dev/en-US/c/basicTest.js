Webruntime.define('lwc/basicTest', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    function tmpl$3($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 0
      }, [api_text("Basics of Lightning Web Components")]), api_element("p", {
        key: 1
      }, [api_text("Re-introducing ourselves to LWC!!!")]), $cmp.detailsActive ? api_element("p", {
        key: 2
      }, [api_text("We can use Directives to conditionally render!")]) : null, api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": $cmp.btnLabel
        },
        key: 3,
        ...
        key: 4
      }, [api_text("We can also used Directives to iterate over a list")]), api_element("div", {
        classMap: {
          "iteration-holder": true
        },
        key: 15
      }, [api_element("ul", {
        key: 9
      }, api_iterator($cmp.myStarter, function (starter) {
        return api_element("li", {
          classMap: {
            "info-holder": true
          },
          key: api_key(8, starter.name)
        }, [api_element("div", {
          classMap: {
            "info": true
          },
          key: 5
        }, [api_dynamic(starter.name)]), api_element("div", {
          classMap: {
            "info": true
          },
          key: 7
        ...
        key: 14
      }, api_flatten([api_element("p", {
        key: 10
      }, [api_text("Using the iterator directive, we can do special functionality on the first and last elements!")]), api_iterator($cmp.myStarter, function (myiteratorValue, myiteratorIndex, myiteratorFirst, myiteratorLast) {
        return api_element("li", {
          key: api_key(13, myiteratorValue.name)
        }, [myiteratorFirst ? api_element("hr", {
          key: 11
        }, []) : null, api_dynamic(myiteratorValue.name), myiteratorLast ? api_element("hr", {
          key: 12
        }, []) : null]);
      })]))])])];
    }
    ...
    tmpl$3.stylesheetTokens = {
      hostAttribute: "lwc-basicTest_basicTest-host",
      shadowAttribute: "lwc-basicTest_basicTest"
    };

    class BasicTest extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.btnLabel = "Hide";
    ...
    lwc.registerDecorators(BasicTest, {
      fields: ["btnLabel", "detailsActive", "myStarter"]
    });

    var basicTest = lwc.registerComponent(BasicTest, {
      tmpl: _tmpl$4
    });
